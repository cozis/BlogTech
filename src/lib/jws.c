...
#define JWK_RSA_N_BASE64_BYTES BASE64_LEN(JWK_RSA_N_BYTES)
#define JWK_RSA_E_BASE64_BYTES BASE64_LEN(JWK_RSA_E_BYTES)

#define JWK_EC_BASE64_BYTES BASE64_LEN(JWK_EC_BYTES)
